        ...
        <div class="col-md-6 mb-2" >  
            ...
            <div class="col-md-12 mb-2" >  
                <div class="form-group">
                   ...
                   <textarea name="role_responsibility" id="summernote" class="form-control" rows="2">
            ...
            <div class="col-md-12 mb-2" >  
                <div class="form-group">
                   ...
                   <textarea name="specification" id="summernote1" class="form-control" rows="2">{{old('specification')}}</textarea>
                </div>
            </div>
            ...
            <div class="col-md-12 mb-2" >  
                <div class="form-group">
                   ...
                   <textarea name="description" id="summernote2" class="form-control" rows="2">{{old('description')}}</textarea>
                </div>
            </div>
